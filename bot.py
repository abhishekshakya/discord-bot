...
async def on_message(message):
    if message.author.name == 'Miss_Mooooo' or message.author.id == 707218152307818507:
        return
    ...
    gali2 = ["BC","bsdk","chut","gand","gaand","dalle","choot","randi","rande","gend","saale","bhadv","bhadw","lavd","lawd","lund","chooch","bkl","choot","gavar","gawar","saali"]
